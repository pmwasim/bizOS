...
CREATE UNIQUE INDEX "api_keys_tenant_id_business_id_id_key" ON "api_keys"("tenant_id", "business_id", "id");
...
CREATE UNIQUE INDEX "webhook_subscriptions_public_id_key" ON "webhook_subscriptions"("public_id");
CREATE UNIQUE INDEX "webhook_subscriptions_tenant_id_business_id_id_key" ON "webhook_subscriptions"("tenant_id", "business_id", "id");
CREATE INDEX "webhook_subscriptions_public_id_idx" ON "webhook_subscriptions"("public_id");
...
CREATE INDEX "webhook_deliveries_webhook_subscription_id_created_at_idx" ON "webhook_deliveries"("webhook_subscription_id", "created_at");
