...
9 workspaces (2 apps, 7 packages) · 10 internal dependency edges · 22 decision records.
...
| `@bizo/web` | app | `apps/web` | `@bizo/config`, `@bizo/contracts`, `@bizo/ui` | — | 73 | 4 |
...
- `apps/api/src/configuration` — 7 source files, 3 test files
- `apps/api/src/customers` — 3 source files, 0 test files
- `apps/api/src/customization` — 7 source files, 3 test files
- `apps/api/src/database` — 2 source files, 0 test files
- `apps/api/src/documents` — 14 source files, 4 test files
...
- `apps/web/src/app` — 43 source files, 2 test files
- `apps/web/src/components` — 19 source files, 0 test files
