...
9 workspaces (2 apps, 7 packages) · 10 internal dependency edges · 30 decision records.
...
| `@bizo/web` | app | `apps/web` | `@bizo/config`, `@bizo/contracts`, `@bizo/ui` | — | 156 | 8 |
...
- `apps/api/src/crm` — 10 source files, 4 test files
...
- `apps/api/src/integration` — 10 source files, 10 test files
...
- `apps/web/src/components` — 51 source files, 0 test files
...
| 0028 | ADR-0028: Stock reservation lifecycle | Accepted Date: 2026-09-03 Deciders: Michael (god) |
