...
| `@bizo/web` | app | `apps/web` | `@bizo/config`, `@bizo/contracts`, `@bizo/ui` | — | 116 | 4 |
...
- `apps/web/src/app` — 68 source files, 2 test files
- `apps/web/src/components` — 37 source files, 0 test files
