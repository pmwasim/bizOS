...
/**
 * Money the business owes its suppliers (MMF-2).
 *
 * Rendered on the server from the API response. There is deliberately no client-side fetch and no
 * fallback data: if the query fails the page reports the failure, because a plausible-looking
 * substitute is worse than an outage on a surface used to decide who to pay (ADR-0024).
 */
    ...
    <div className="page">
      <header className="page-header">
        <div>
          ...
          <p>
            Which supplier bills are approved and unpaid, what they come to, and how overdue they
            are — from the bills recorded in this business.
          </p>
        </div>
      </header>
